...
public class Base64CODEC {
	...
	private void copyCompletely(InputStream input, OutputStream output)
			throws IOException {
	...
	public Bitmap convertToBitmap(String base64String) {
		...
		Bitmap bitmapResult = BitmapFactory.decodeByteArray(decodedString, 0,
				decodedString.length);
		return bitmapResult;
	}

	public static void main(String s[]) {
		String url = "http://www.repstatic.it/content/nazionale/img/2014/11/11/002412447-f4eb6c5e-aaf4-4830-aa30-abe313db3db6.jpg";
		Base64CODEC cod = new Base64CODEC();
		Bitmap bitmap = cod.Base64ImageFromURL(url);
